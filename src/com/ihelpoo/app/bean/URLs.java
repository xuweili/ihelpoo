...
//    public final static String LOCALHOST = "api.ihelpoo.cn";
    ...
    public static final String USER_UPDATE_MAJOR = "http://api.ihelpoo.cn/v1.1/updateMajor.xml";
    public static final String USER_UPDATE_NICKNAME = "http://api.ihelpoo.cn/v1.1/updateNickname.xml";
    public static final String USER_UPDATE_GENDER = "http://api.ihelpoo.cn/v1.1/updateGender.xml";
    public static final String USER_UPDATE_ENROL = "http://api.ihelpoo.cn/v1.1/updateEnrol.xml";
    public static final String USER_UPDATE_INTRO = "http://api.ihelpoo.cn/v1.1/updateIntro.xml";

    public static final String MAJOR_LIST = "http://api.ihelpoo.cn/v1.1/majors.xml";
    public static final String DORM_LIST = "http://api.ihelpoo.cn/v1.1/dorms.xml";
    public final static String ACADEMY_LIST = "http://api.ihelpoo.cn/v1.1/academies.xml";
    public final static String SCHOOL_LIST = "http://api.ihelpoo.cn/v1.1/schools.xml";
    public final static String MOBILE_CODE = "http://api.ihelpoo.cn/v1.1/mobileCode.xml";
    public final static String MOBILE_REGISTER = "http://api.ihelpoo.cn/v1.1/mobileRegister.xml";
    public static final String THIRD_LOGIN = "http://api.ihelpoo.cn/v1.1/thirdLogin.xml";

    //	public final static String LOGIN_VALIDATE_HTTP = HTTP + HOST + URL_SPLITTER + "action/api/login_validate";
    public final static String LOGIN_VALIDATE_HTTP = "http://api.ihelpoo.cn/v1.1/login.xml";
...
//    public final static String NOTICE_LIST = URL_API_HOST + "action/api/news_list";
    public final static String NOTICE_LIST = "http://api.ihelpoo.cn/v1.1/notices.xml";
    public final static String NEST_LIST = "http://api.ihelpoo.cn/v1.1/active.xml";
    public final static String NEWS_DETAIL = URL_API_HOST + "action/api/news_detail";
    //	public final static String POST_LIST = "http://api.ihelpoo.cn/v1.1/posts.xml";
    public final static String POST_LIST = "http://api.ihelpoo.cn/v1.1/posts.xml";
    ...
    public final static String TWEET_LIST = "http://api.ihelpoo.cn/v1.1/tweets.xml";
    //	public final static String TWEET_DETAIL = URL_API_HOST+"action/api/tweet_detail";
    public final static String TWEET_DETAIL = "http://api.ihelpoo.cn/v1.1/tweets/${id}.xml";
//    public final static String TWEET_PUB = URL_API_HOST + "action/api/tweet_pub";
    public final static String TWEET_PUB = "http://api.ihelpoo.cn/v1.1/pubTweet.xml";
//    public final static String TWEET_DELETE = URL_API_HOST + "action/api/tweet_delete";
    public final static String TWEET_DELETE = "http://api.ihelpoo.cn/v1.1/delTweet.xml";
    //	public final static String WORD_LIST = URL_API_HOST+"action/api/active_list";
    public final static String WORD_LIST = "http://api.ihelpoo.cn/v1.1/words.xml";

//    public final static String MESSAGE_LIST = URL_API_HOST + "action/api/message_list";
    public final static String MESSAGE_LIST = "http://api.ihelpoo.cn/v1.1/chats.xml";
//    public final static String MESSAGE_DELETE = URL_API_HOST + "action/api/message_delete";
    public final static String MESSAGE_DELETE = "http://api.ihelpoo.cn/v1.1/delChat.xml";
//    public final static String MESSAGE_PUB = URL_API_HOST + "action/api/message_pub";
    public final static String MESSAGE_PUB = "http://api.ihelpoo.cn/v1.1/doChat.xml";
    //	public final static String COMMENT_LIST = URL_API_HOST+"action/api/comment_list";
    public final static String COMMENT_LIST = "http://api.ihelpoo.cn/v1.1/comments.xml";
    //	public final static String COMMENT_PUB = URL_API_HOST+"action/api/comment_pub";
    public final static String COMMENT_PUB = "http://api.ihelpoo.cn/v1.1/commentPush.xml";
    public final static String PLUS = "http://api.ihelpoo.cn/v1.1/plus.xml";
    public final static String DIFFUSE = "http://api.ihelpoo.cn/v1.1/diffuse.xml";
    //	public final static String COMMENT_REPLY = URL_API_HOST+"action/api/comment_reply";
    public final static String COMMENT_REPLY = "http://api.ihelpoo.cn/v1.1/commentReply.xml";
//    public final static String COMMENT_DELETE = URL_API_HOST + "action/api/comment_delete";
    public final static String COMMENT_DELETE = "http://api.ihelpoo.cn/v1.1/commentDelete.xml";
...
//    public final static String MY_INFORMATION = URL_API_HOST + "action/api/my_information";
    public final static String MY_INFORMATION = "http://api.ihelpoo.cn/v1.1/user/${uid}.xml";
//    public final static String USER_INFORMATION = URL_API_HOST + "action/api/user_information";
    public final static String USER_INFORMATION ="http://api.ihelpoo.cn/v1.1/userActive.xml";
//    public final static String USER_UPDATERELATION = URL_API_HOST + "action/api/user_updaterelation";
    public final static String USER_UPDATERELATION = "http://api.ihelpoo.cn/v1.1/updateRelation.xml";
    //	public final static String USER_NOTICE = URL_API_HOST+"action/api/user_notice";
    public final static String USER_NOTICE = "http://api.ihelpoo.cn/v1.1/noticeBound.xml";
//    public final static String NOTICE_CLEAR = URL_API_HOST + "action/api/notice_clear";
    public final static String NOTICE_CLEAR = "http://api.ihelpoo.cn/v1.1/noticeClear.xml";

    public final static String FRIENDS_LIST = "http://api.ihelpoo.cn/v1.1/buddies.xml";
...
//    public final static String PORTRAIT_UPDATE = URL_API_HOST + "action/api/portrait_update";
    public final static String PORTRAIT_UPDATE = "http://api.ihelpoo.cn/v1.1/avatarUpload.xml";
