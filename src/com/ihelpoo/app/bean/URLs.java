...
public class URLs implements Serializable {
    ...
    public final static String LOCALHOST = "api.ihelpoo.com";
...
//    public final static String NEWS_LIST = URL_API_HOST + "action/api/news_list";
    public final static String NEWS_LIST = "http://api.ihelpoo.com/v1/notices.xml";
    ...
    public final static String WORD_LIST = "http://api.ihelpoo.com/v1/words.xml";

//    public final static String MESSAGE_LIST = URL_API_HOST + "action/api/message_list";
    public final static String MESSAGE_LIST = "http://api.ihelpoo.com/v1/chats.xml";
