...
import com.ihelpoo.app.adapter.ListViewSearchAdapter;
...
public class Search extends BaseActivity{
	...
	private List<SearchList.Result> lvSearchData = new ArrayList<SearchList.Result>();
					...
					case UIHelper.LISTVIEW_ACTION_SCROLL:
						...
						if(lvSearchData.size() > 0){
							for(SearchList.Result res1 : list.getResultlist()){
								boolean b = false;
								for(SearchList.Result res2 : lvSearchData){
