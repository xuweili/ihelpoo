 ...
 * @author Linhai
 */
public class ScrollViewForNest extends ScrollView {
    private Handler handler;
    private View view;

    public ScrollViewForNest(Context context) {
        super(context);
    }

    public ScrollViewForNest(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ScrollViewForNest(Context context, AttributeSet attrs, int defStyle) {
