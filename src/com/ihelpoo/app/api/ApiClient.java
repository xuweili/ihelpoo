...
//			put("pageSize", pageSize);
     ...
     * @throws AppException
     */
    public static CommentList getCommentList(AppContext appContext, final boolean isHelp, final int catalog, final int uid, final int id, final int pageIndex, final int pageSize) throws AppException {
    ...
    public static Result plus(AppContext appContext, int id, int uid) throws AppException {
        ...
        try {
            return http_post(appContext, URLs.PLUS, params, null);
        } catch (Exception e) {
            if (e instanceof AppException)
                throw (AppException) e;
            throw AppException.network(e);
    ...
    public static Result updateNickname(AppContext appContext, int uid, String nickname) throws AppException {
        Map<String, Object> params = new HashMap<String, Object>();
        params.put("uid", uid);
        params.put("nickname", nickname);

        try {
            return Result.parse(_post(appContext, URLs.USER_UPDATE_NICKNAME, params, null));
        } catch (Exception e) {
            if (e instanceof AppException)
                throw (AppException) e;
            throw AppException.network(e);
    ...
    public static Result updateGender(AppContext appContext, int uid, String gender) throws AppException {
        Map<String, Object> params = new HashMap<String, Object>();
        params.put("uid", uid);
        params.put("gender", gender);

        try {
            return Result.parse(_post(appContext, URLs.USER_UPDATE_GENDER, params, null));
        } catch (Exception e) {
            if (e instanceof AppException)
                throw (AppException) e;
            throw AppException.network(e);
    ...
    public static Result updateEnrol(AppContext appContext, int uid, String newEnrol) throws AppException {
        Map<String, Object> params = new HashMap<String, Object>();
        params.put("uid", uid);
        params.put("enrol", newEnrol);

        try {
            return Result.parse(_post(appContext, URLs.USER_UPDATE_ENROL, params, null));
        } catch (Exception e) {
            if (e instanceof AppException)
                throw (AppException) e;
            throw AppException.network(e);
    ...
    public static Result updateIntro(AppContext appContext, int uid, String intro) throws AppException {
        Map<String, Object> params = new HashMap<String, Object>();
        params.put("uid", uid);
        params.put("intro", intro);

        try {
            return Result.parse(_post(appContext, URLs.USER_UPDATE_INTRO, params, null));
        } catch (Exception e) {
            if (e instanceof AppException)
                throw (AppException) e;
            throw AppException.network(e);
    ...
    public static AcademyList getAcademyList(AppContext appContext, final int schoolId) throws AppException {
        String newUrl = _MakeURL(URLs.ACADEMY_LIST, new HashMap<String, Object>() {{
            put("school_id", schoolId);
        }});

        try {
            return AcademyList.parse(http_get(appContext, newUrl));
        } catch (Exception e) {
            if (e instanceof AppException)
                throw (AppException) e;
            throw AppException.network(e);
    ...
    public static MajorList getMajorList(AppContext appContext, final int schoolId, final Integer academyId) throws AppException {
        String newUrl = _MakeURL(URLs.MAJOR_LIST, new HashMap<String, Object>() {{
            put("school_id", schoolId);
            put("academy_id", academyId);
        }});

        try {
            return MajorList.parse(http_get(appContext, newUrl));
        } catch (Exception e) {
            if (e instanceof AppException)
                throw (AppException) e;
            throw AppException.network(e);
    ...
    public static DormList getDormList(AppContext appContext, final int schoolId) throws AppException {
        String newUrl = _MakeURL(URLs.DORM_LIST, new HashMap<String, Object>() {{
            put("school_id", schoolId);
        }});

        try {
            return DormList.parse(http_get(appContext, newUrl));
        } catch (Exception e) {
            if (e instanceof AppException)
                throw (AppException) e;
            throw AppException.network(e);
