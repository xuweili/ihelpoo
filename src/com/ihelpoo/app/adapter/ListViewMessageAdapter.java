...
public class ListViewMessageAdapter extends MyBaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            listItemView.username = (LinkView) convertView.findViewById(R.id.message_listitem_username);
        ...
        if (msg.getSenderId() == ac.getLoginUid()) {
            UIHelper.parseMessageSpan(listItemView.username, msg.getFriendName(), msg.getContent(), "发给 ");
        } else {
        ...
        listItemView.messageCount.setText("共 " + msg.getMessageCount() + " 条");
